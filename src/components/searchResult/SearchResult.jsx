                ...
                searchResult?.results.map(multi => (
                    <article className="col-sm-6 col-md-4 col-lg-2">
                        <div className="card w-100">
                          ...
                          <div className="card-body" style={{ height: 275 }}>
                            <h5 className="card-title">{handleTitleByMediaType(multi)}</h5>
                            <p className="card-text limit-movie-overview">{multi.overview}</p>
                            <Link to={handleLinkByMediaType(multi)} className="btn btn-primary w-100">See More</Link>
                          </div>
                        </div>
                    </article>
                ))
